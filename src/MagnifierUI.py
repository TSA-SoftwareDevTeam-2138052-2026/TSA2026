...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.magnify = QPushButton(self.centralwidget)
        ...
        sizePolicy.setHeightForWidth(self.magnify.sizePolicy().hasHeightForWidth())
        self.magnify.setSizePolicy(sizePolicy)
        font = QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.magnify.setText(QCoreApplication.translate("MainWindow", u"Magnify...", None))
    # retranslateUi
